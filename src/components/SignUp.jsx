    ...
    <div className="flex justify-center items-center my-5">
      <div className="card bg-base-300 w-96 shadow-md rounded-2xl">
        <div className="card-body">
          <h2 className="card-title justify-center text-2xl mb-6">SignUp</h2>
          ...
          <div className="justify-center">
            <button
              className="btn btn-neutral w-full rounded-lg bg-blue-800 hover:bg-blue-900"
              onClick={handleSignUpClick}>
              Signup
            </button>
             <Link to="/login" className=""> <button className="btn btn-neutral rounded-lg bg-blue-800 hover:bg-blue-900 w-full mt-3">Login</button></Link>
